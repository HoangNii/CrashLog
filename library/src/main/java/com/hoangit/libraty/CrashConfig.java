...
public class CrashConfig implements Serializable {
    ...
    private CrashManager.EventListener eventListener = null;
    ...
    @Nullable
    public CrashManager.EventListener getEventListener() {
        return eventListener;
    }

    public void setEventListener(@Nullable CrashManager.EventListener eventListener) {
    ...
    public static class Builder {
        ...
        public static Builder create() {
            ...
            CrashConfig currentConfig = CrashManager.getConfig();
        ...
        /**
         * Defines if CrashManager crash interception mechanism is enabled.
         * Set it to true if you want CrashManager to intercept crashes,
         ...
         */
        @NonNull
        public Builder eventListener(@Nullable CrashManager.EventListener eventListener) {
